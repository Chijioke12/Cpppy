...
var _malloc, _main, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["Cd"];
  _main = Module["_main"] = wasmExports["Dd"];
  __emscripten_stack_restore = wasmExports["Ed"];
  __emscripten_stack_alloc = wasmExports["Fd"];
  _emscripten_stack_get_current = wasmExports["Gd"];
  memory = wasmMemory = wasmExports["zd"];
  __indirect_function_table = wasmTable = wasmExports["Bd"];
}
...
var wasmImports = {
  ...
  /** @export */ Lb: _eglBindAPI,
  /** @export */ Ac: _eglChooseConfig,
  /** @export */ Ja: _eglCreateContext,
  /** @export */ La: _eglCreateWindowSurface,
  /** @export */ Ka: _eglDestroyContext,
  /** @export */ Ma: _eglDestroySurface,
  /** @export */ Lc: _eglGetConfigAttrib,
  /** @export */ K: _eglGetDisplay,
  /** @export */ Ia: _eglGetError,
  /** @export */ ec: _eglInitialize,
  /** @export */ Oa: _eglMakeCurrent,
  /** @export */ Ga: _eglQueryString,
  /** @export */ Wa: _eglSwapBuffers,
  /** @export */ eb: _eglSwapInterval,
  /** @export */ pc: _eglTerminate,
  ...
  /** @export */ ya: _emscripten_exit_fullscreen,
  /** @export */ Da: _emscripten_exit_pointerlock,
  /** @export */ Ca: _emscripten_force_exit,
  /** @export */ e: _emscripten_get_device_pixel_ratio,
  /** @export */ c: _emscripten_get_element_css_size,
  /** @export */ i: _emscripten_get_gamepad_status,
  /** @export */ F: _emscripten_get_now,
  /** @export */ fa: _emscripten_get_num_gamepads,
  /** @export */ Fa: _emscripten_get_screen_size,
  /** @export */ da: _emscripten_glActiveTexture,
  /** @export */ ca: _emscripten_glAttachShader,
  /** @export */ ua: _emscripten_glBeginQueryEXT,
  /** @export */ ba: _emscripten_glBindAttribLocation,
  /** @export */ aa: _emscripten_glBindBuffer,
  /** @export */ $: _emscripten_glBindFramebuffer,
  /** @export */ _: _emscripten_glBindRenderbuffer,
  /** @export */ Z: _emscripten_glBindTexture,
  /** @export */ ma: _emscripten_glBindVertexArrayOES,
  /** @export */ Y: _emscripten_glBlendColor,
  /** @export */ X: _emscripten_glBlendEquation,
  /** @export */ W: _emscripten_glBlendEquationSeparate,
  /** @export */ V: _emscripten_glBlendFunc,
  /** @export */ U: _emscripten_glBlendFuncSeparate,
  /** @export */ T: _emscripten_glBufferData,
  /** @export */ S: _emscripten_glBufferSubData,
  /** @export */ R: _emscripten_glCheckFramebufferStatus,
  /** @export */ Q: _emscripten_glClear,
  /** @export */ P: _emscripten_glClearColor,
  /** @export */ O: _emscripten_glClearDepthf,
  /** @export */ N: _emscripten_glClearStencil,
  /** @export */ $a: _emscripten_glClipControlEXT,
  /** @export */ xd: _emscripten_glColorMask,
  /** @export */ wd: _emscripten_glCompileShader,
  /** @export */ vd: _emscripten_glCompressedTexImage2D,
  /** @export */ ud: _emscripten_glCompressedTexSubImage2D,
  /** @export */ td: _emscripten_glCopyTexImage2D,
  /** @export */ sd: _emscripten_glCopyTexSubImage2D,
  /** @export */ rd: _emscripten_glCreateProgram,
  /** @export */ qd: _emscripten_glCreateShader,
  /** @export */ pd: _emscripten_glCullFace,
  /** @export */ od: _emscripten_glDeleteBuffers,
  /** @export */ nd: _emscripten_glDeleteFramebuffers,
  /** @export */ md: _emscripten_glDeleteProgram,
  /** @export */ wa: _emscripten_glDeleteQueriesEXT,
  /** @export */ ld: _emscripten_glDeleteRenderbuffers,
  /** @export */ kd: _emscripten_glDeleteShader,
  /** @export */ jd: _emscripten_glDeleteTextures,
  /** @export */ la: _emscripten_glDeleteVertexArraysOES,
  /** @export */ id: _emscripten_glDepthFunc,
  ...
  /** @export */ ha: _emscripten_glDrawArraysInstancedANGLE,
  /** @export */ ia: _emscripten_glDrawBuffersWEBGL,
  /** @export */ bd: _emscripten_glDrawElements,
  /** @export */ ga: _emscripten_glDrawElementsInstancedANGLE,
  /** @export */ ad: _emscripten_glEnable,
  /** @export */ $c: _emscripten_glEnableVertexAttribArray,
  /** @export */ ta: _emscripten_glEndQueryEXT,
  /** @export */ _c: _emscripten_glFinish,
  /** @export */ Zc: _emscripten_glFlush,
  /** @export */ Yc: _emscripten_glFramebufferRenderbuffer,
  /** @export */ Xc: _emscripten_glFramebufferTexture2D,
  /** @export */ Wc: _emscripten_glFrontFace,
  /** @export */ Vc: _emscripten_glGenBuffers,
  /** @export */ Tc: _emscripten_glGenFramebuffers,
  /** @export */ xa: _emscripten_glGenQueriesEXT,
  /** @export */ Sc: _emscripten_glGenRenderbuffers,
  /** @export */ Rc: _emscripten_glGenTextures,
  /** @export */ ka: _emscripten_glGenVertexArraysOES,
  /** @export */ Uc: _emscripten_glGenerateMipmap,
  /** @export */ Qc: _emscripten_glGetActiveAttrib,
  /** @export */ Pc: _emscripten_glGetActiveUniform,
  /** @export */ Oc: _emscripten_glGetAttachedShaders,
  /** @export */ Nc: _emscripten_glGetAttribLocation,
  /** @export */ Mc: _emscripten_glGetBooleanv,
  ...
  /** @export */ Ec: _emscripten_glGetProgramInfoLog,
  /** @export */ Fc: _emscripten_glGetProgramiv,
  /** @export */ oa: _emscripten_glGetQueryObjecti64vEXT,
  /** @export */ qa: _emscripten_glGetQueryObjectivEXT,
  /** @export */ na: _emscripten_glGetQueryObjectui64vEXT,
  /** @export */ pa: _emscripten_glGetQueryObjectuivEXT,
  /** @export */ ra: _emscripten_glGetQueryivEXT,
  /** @export */ Dc: _emscripten_glGetRenderbufferParameteriv,
  ...
  /** @export */ Cc: _emscripten_glGetShaderiv,
  /** @export */ xc: _emscripten_glGetString,
  /** @export */ wc: _emscripten_glGetTexParameterfv,
  /** @export */ vc: _emscripten_glGetTexParameteriv,
  /** @export */ sc: _emscripten_glGetUniformLocation,
  /** @export */ uc: _emscripten_glGetUniformfv,
  /** @export */ tc: _emscripten_glGetUniformiv,
  /** @export */ oc: _emscripten_glGetVertexAttribPointerv,
  /** @export */ rc: _emscripten_glGetVertexAttribfv,
  /** @export */ qc: _emscripten_glGetVertexAttribiv,
  ...
  /** @export */ va: _emscripten_glIsQueryEXT,
  /** @export */ ic: _emscripten_glIsRenderbuffer,
  /** @export */ hc: _emscripten_glIsShader,
  /** @export */ gc: _emscripten_glIsTexture,
  /** @export */ ja: _emscripten_glIsVertexArrayOES,
  /** @export */ fc: _emscripten_glLineWidth,
  /** @export */ dc: _emscripten_glLinkProgram,
  /** @export */ cc: _emscripten_glPixelStorei,
  /** @export */ _a: _emscripten_glPolygonModeWEBGL,
  /** @export */ bc: _emscripten_glPolygonOffset,
  /** @export */ ab: _emscripten_glPolygonOffsetClampEXT,
  /** @export */ sa: _emscripten_glQueryCounterEXT,
  ...
  /** @export */ Yb: _emscripten_glScissor,
  /** @export */ Xb: _emscripten_glShaderBinary,
  /** @export */ Wb: _emscripten_glShaderSource,
  /** @export */ Vb: _emscripten_glStencilFunc,
  /** @export */ Ub: _emscripten_glStencilFuncSeparate,
  /** @export */ Tb: _emscripten_glStencilMask,
  /** @export */ Sb: _emscripten_glStencilMaskSeparate,
  /** @export */ Rb: _emscripten_glStencilOp,
  /** @export */ Qb: _emscripten_glStencilOpSeparate,
  /** @export */ Pb: _emscripten_glTexImage2D,
  ...
  /** @export */ ea: _emscripten_glVertexAttribDivisorANGLE,
  /** @export */ cb: _emscripten_glVertexAttribPointer,
  /** @export */ bb: _emscripten_glViewport,
  /** @export */ h: _emscripten_has_asyncify,
  /** @export */ za: _emscripten_request_fullscreen_strategy,
  /** @export */ E: _emscripten_request_pointerlock,
  /** @export */ Pa: _emscripten_resize_heap,
  /** @export */ j: _emscripten_sample_gamepad_data,
  /** @export */ k: _emscripten_set_beforeunload_callback_on_thread,
  /** @export */ w: _emscripten_set_blur_callback_on_thread,
  /** @export */ d: _emscripten_set_canvas_element_size,
  /** @export */ f: _emscripten_set_element_css_size,
  /** @export */ x: _emscripten_set_focus_callback_on_thread,
  /** @export */ n: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ M: _emscripten_set_gamepadconnected_callback_on_thread,
  /** @export */ L: _emscripten_set_gamepaddisconnected_callback_on_thread,
  /** @export */ q: _emscripten_set_keydown_callback_on_thread,
  /** @export */ o: _emscripten_set_keypress_callback_on_thread,
  /** @export */ p: _emscripten_set_keyup_callback_on_thread,
  /** @export */ yd: _emscripten_set_main_loop,
  /** @export */ C: _emscripten_set_mousedown_callback_on_thread,
  /** @export */ A: _emscripten_set_mouseenter_callback_on_thread,
  /** @export */ z: _emscripten_set_mouseleave_callback_on_thread,
  /** @export */ D: _emscripten_set_mousemove_callback_on_thread,
  /** @export */ B: _emscripten_set_mouseup_callback_on_thread,
  /** @export */ r: _emscripten_set_pointerlockchange_callback_on_thread,
  /** @export */ m: _emscripten_set_resize_callback_on_thread,
  /** @export */ s: _emscripten_set_touchcancel_callback_on_thread,
  /** @export */ u: _emscripten_set_touchend_callback_on_thread,
  /** @export */ t: _emscripten_set_touchmove_callback_on_thread,
  /** @export */ v: _emscripten_set_touchstart_callback_on_thread,
  /** @export */ l: _emscripten_set_visibilitychange_callback_on_thread,
  /** @export */ y: _emscripten_set_wheel_callback_on_thread,
